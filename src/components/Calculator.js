  ...
  render() {
    return (
      <div className="calculator">
        <div className="calc-display" id="calcDisplay">
          <span>0</span>
        </div>
        ...
        <div className="second-row">
          <button type="button" onClick={this.btnClick} value="7">
            7
            {' '}
          </button>
          <button type="button" onClick={this.btnClick} value="8">
            8
          </button>
        ...
        <div className="third-row">
          ...
          <button type="button" onClick={this.btnClick} value="6">
            6
          </button>
          <button type="button" onClick={this.btnClick} value="-" className="orange">
            -
        ...
        <div className="first-row">
          ...
          <button type="button" onClick={this.btnClick} value="3">
            3
          </button>
          <button type="button" onClick={this.btnClick} value="+" className="orange">
            +
